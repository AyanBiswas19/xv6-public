...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer -D $(SCHEDULE_TYPE)
...
EXTRA=\
	...
	shutdown.c test_waitx.c time.c pinfo.c\
	printf.c umalloc.c\
